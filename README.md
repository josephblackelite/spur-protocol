...
```sh
pnpm add @spurprotocol/types@^0.3.0 @spurprotocol/validator@^0.3.0 @spurprotocol/compiler@^0.3.0
npm i @spurprotocol/types@^0.3.0 @spurprotocol/validator@^0.3.0 @spurprotocol/compiler@^0.3.0
yarn add @spurprotocol/types@^0.3.0 @spurprotocol/validator@^0.3.0 @spurprotocol/compiler@^0.3.0
```
...
Packages are versioned using SemVer. Current status remains Draft (v0.3).

## Status

Draft (v0.3 in progress)
