...
function coerceMajorNodeVersion(version) {
...
function checkAdapterContract(adapterContract) {
    const adapter = adapterContract;
    const contractOk = Boolean(adapter.adapterId
...
function checkPackageResolvable(packageName) {
    try {
        require(packageName);
        return {
